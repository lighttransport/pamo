...
@wp.func
def update_dd_dx(dd_dx: Dd_dx, i: int, d: wp.vec3):
    # This is so ugly. I'm sorry.
    # TODO: Ask Fanbo about this.
...
def pp_distance_grad_struct(
    ...
    dd_dx = Dd_dx()
    dd_dx.d0 = wp.vec3(0.0)
    dd_dx.d1 = wp.vec3(0.0)
    dd_dx.d2 = wp.vec3(0.0)
    dd_dx.d3 = wp.vec3(0.0)
    
    dd_dx = update_dd_dx(dd_dx, i0, wp.normalize(x0 - x1))
    dd_dx = update_dd_dx(dd_dx, i1, wp.normalize(x1 - x0))
    return dd_dx


@wp.func
def ee_distance_grad_struct(x0: wp.vec3, x1: wp.vec3, x2: wp.vec3, x3: wp.vec3) -> Dd_dx:
    x01 = x0[0]
    x02 = x0[1]
    x03 = x0[2]
...
@wp.func
def pt_distance_grad_struct(x0: wp.vec3, x1: wp.vec3, x2: wp.vec3, x3: wp.vec3) -> Dd_dx:
    x01 = x0[0]
    x02 = x0[1]
    x03 = x0[2]
